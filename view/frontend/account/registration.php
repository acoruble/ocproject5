  ...
  <div class="container">
    <div class="row">
      <div class="mx-auto col-lg-6 col-10">
        ...
        <form method="post" action="registration_post" class="text-left">
          ...
          <div class="form-group">
            <div class="form-check"> <input class="form-check-input" type="checkbox" id="form21" value="on" required> <label class="form-check-label" for="form21">Je suis d'accord avec <a href="CGU" class="text-secondary">Les conditions d'utilisations </a>du site du co-voiturage du pays flèchois</label> </div>
